"""Facebook like feature implementation."""
...
class FacebookLikeFeature:
    """Handle Facebook page like operations through Like4Like."""
    ...
    def get_like_task(self, cookies: str) -> Optional[Dict]:
        """Get a Facebook like task from Like4Like.
        ...
        try:
            ...
            response = make_request(
                method="GET",
                url=f"{LIKE4LIKE_BASE_URL}/user/earn-facebook.php",
            ...
            self.session.headers.update({
                "Referer": f"{LIKE4LIKE_BASE_URL}/user/earn-facebook.php",
            ...
            response = make_request(
                method="GET",
                url=f"{LIKE4LIKE_BASE_URL}/api/get-tasks.php?feature=facebook",
                session=self.session,
                cookies={"Cookie": cookies}
            )
            ...
            raise FeatureError(f"Failed to get Facebook like task: {str(e)}")

    def start_task(self, cookies: str, task: Dict) -> bool:
        """Start a Facebook like task.
    ...
    def validate_task(self, cookies: str, task: Dict) -> bool:
        """Validate a completed Facebook like task.
    ...
    def execute_like_cycle(self, cookies: str) -> bool:
        """Execute a complete Facebook like cycle.
