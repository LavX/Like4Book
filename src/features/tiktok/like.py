"""TikTok like feature implementation."""
...
class TikTokLikeFeature:
    """Handle TikTok like operations through Like4Like."""

    def __init__(self):
        """Initialize TikTok like feature."""
        self.session = create_session()
        self.credits_service = CreditsService()

    def get_like_task(self, cookies: str) -> Optional[Dict]:
        """Get a TikTok like task from Like4Like.
        ...
        try:
            ...
            response = make_request(
                method="GET",
                url=f"{LIKE4LIKE_BASE_URL}/user/earn-tiktok-like.php",
            ...
            self.session.headers.update({
                "Referer": f"{LIKE4LIKE_BASE_URL}/user/earn-tiktok-like.php",
            ...
            response = make_request(
                method="GET",
                url=f"{LIKE4LIKE_BASE_URL}/api/get-tasks.php?feature={FEATURE_TYPES['TIKTOK_LIKE']}",
                session=self.session,
                cookies={"Cookie": cookies}
            )
            ...
            raise FeatureError(f"Failed to get TikTok like task: {str(e)}")

    def start_task(self, cookies: str, task: Dict) -> bool:
        """Start a TikTok like task.
        ...
        try:
            ...
            response = make_request(
                ...
                params={
                    ...
                    "vrsta": "like",
                    "idcod": task["taskId"],
                    "feature": FEATURE_TYPES['TIKTOK_LIKE'],
                    "_": timestamp
                }
            )
    ...
    def validate_task(self, cookies: str, task: Dict) -> bool:
        """Validate a completed TikTok like task.
        ...
        try:
            ...
            data = {
                "url": f"https://www.tiktok.com/@{task['idlink']}/video/{task['code3']}",
                "idlinka": task["idlink"],
                "idzad": task["taskId"],
                "addon": "false",
                "version": "",
    ...
    def execute_like_cycle(self, cookies: str) -> bool:
        """Execute a complete TikTok like cycle.
