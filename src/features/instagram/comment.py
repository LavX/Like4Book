"""Instagram comment feature implementation."""
...
class InstagramCommentFeature:
    """Handle Instagram comment operations through Like4Like."""

    def __init__(self):
        """Initialize Instagram comment feature."""
        self.session = create_session()
        self.credits_service = CreditsService()

    def get_comment_task(self, cookies: str) -> Optional[Dict]:
        """Get an Instagram comment task from Like4Like.
        ...
        try:
            ...
            response = make_request(
                method="GET",
                url=f"{LIKE4LIKE_BASE_URL}/user/earn-instagram-comment.php",
            ...
            self.session.headers.update({
                "Referer": f"{LIKE4LIKE_BASE_URL}/user/earn-instagram-comment.php",
            ...
            response = make_request(
                method="GET",
                url=f"{LIKE4LIKE_BASE_URL}/api/get-tasks.php?feature={FEATURE_TYPES['INSTAGRAM_COMMENT']}",
                session=self.session,
                cookies={"Cookie": cookies}
            )
            ...
            raise FeatureError(f"Failed to get Instagram comment task: {str(e)}")

    def start_task(self, cookies: str, task: Dict) -> bool:
        """Start an Instagram comment task.
        ...
        try:
            ...
            response = make_request(
                ...
                params={
                    ...
                    "vrsta": "comment",
                    "idcod": task["taskId"],
                    "feature": FEATURE_TYPES['INSTAGRAM_COMMENT'],
                    "_": timestamp
                }
            )
    ...
    def validate_task(self, cookies: str, task: Dict) -> bool:
        """Validate a completed Instagram comment task.
        ...
        try:
            ...
            data = {
                "url": f"https://www.instagram.com/p/{task['idlink']}/",
                "idlinka": task["idlink"],
                "idzad": task["taskId"],
                "addon": "false",
                "version": "",
    ...
    def execute_comment_cycle(self, cookies: str) -> bool:
        """Execute a complete Instagram comment cycle.
